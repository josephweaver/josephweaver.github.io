# Question 4 — Survival Guide Write-Up  
*(Source: 2018.q4.pdf)*

### Problem Statement (as written in your PDF)

Let $(\Omega,\mathcal F,P)$ be a probability space.  
Let $\{B_t, 0\le t\le 1\}$ be Brownian motion.  
Let $([0,1],\mathcal B,\lambda)$ be a measure space where $\mathcal B$ is the Borel σ-algebra and $\lambda$ is Lebesgue measure.  
Let  
$$
