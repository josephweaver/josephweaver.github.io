...
> $$
!!! note "my anotation" 
    $\int_S = \int_\Omega\int_[0,1]$ which mean fubini/tonelli is in play.
>
> b. Let
> $$
...
(S,\mathcal G,\mu) = (\Omega\times[0,1],\ \mathcal F\times\mathcal B,\ P\times\lambda)
$$
> be the product measure space.
>
> Define  
> $$
h:S\to\mathbb R,\qquad h(\omega,t)=B_t(\omega).
$$
